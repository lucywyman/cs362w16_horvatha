...
int smithycard (struct gameState *state, int currentPlayer, int handPos, int i){//+3 Cards
  for (i = 0; i < 3; i++) {
...
int treasure_mapcard(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int i, int currentPlayer , int index){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
      ...
      for (i = 0; i < state->numPlayers; i++)
  {
    ...
    case smithy:
      smithycard(state, currentPlayer, handPos, i);
   ...
   if (i != currentPlayer){
    ...
    case treasure_map:
      treasure_mapcard(card, choice1,choice2, choice3, state, handPos, bonus,  i,  currentPlayer, index);
